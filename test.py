...
def createPredImg2(input_train, input_test, difference_reshaped, image, num, path_results):
    fig, axes = plt.subplots(1, 3, figsize=(24,8))
    fig.suptitle('Input data vs Results')
...
if __name__ =='__main__':
    ...
    #If we want to see if there is a welding error in a piece. 
        ...
        #Data loading
        images = []
        sorted_filenames = sorted(os.listdir('/home/jean-sebastien/Documents/s7/PMC/results_un_supervised/aes_defect_detection/4k_images_blackout/image/subdivised/image1/imageView_1/segment_0'), key=custom_sort_key2)
        for filename in sorted_filenames:
            if filename.endswith(".jpg"):
                images.append(cv2.imread(f'/home/jean-sebastien/Documents/s7/PMC/results_un_supervised/aes_defect_detection/4k_images_blackout/image/subdivised/image1/imageView_1/segment_0/{filename}'))
        ...
        for img in images:
            ...
            createPredImg2(input_train, input_test, difference_reshaped, image, num, path_results)
